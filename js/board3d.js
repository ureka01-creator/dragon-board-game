// DRAGON BOARD V0.6.1.5 — persistent WebGL board + live movement bridge
...
function ensureSceneDie() {
  ...
  sceneDie = new THREE.Mesh(new THREE.BoxGeometry(.54,.54,.54), materials);
